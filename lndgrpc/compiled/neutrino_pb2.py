...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _NEUTRINOKIT.methods_by_name['GetBlockHash']._options = None
  _NEUTRINOKIT.methods_by_name['GetBlockHash']._serialized_options = b'\210\002\001'
  ...
  _NEUTRINOKIT._serialized_end=1837
